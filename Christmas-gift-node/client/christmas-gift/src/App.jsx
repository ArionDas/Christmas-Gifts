...
const GeminiGiftGenerator = () => {
  ...
  const geminiText = async () => {
    ...
    const prompt =
      ...
      `Please make the person happy with your gift ideas!!` + `just provide the name of the gift and no description with separated by comma`;
      ...
      <div className="gemini-gift-generator text-white p-8 max-w-xl mx-auto  rounded shadow-lg backdrop-blur-[2px] z-10">
        ...
        <div className="text-center mb-6">
          <svg
            ...
            className="w-12 h-12 mx-auto fill-current text-red-600"
          >
            {/* {ReactSVG} */}
          </svg>
        </div>
          ...
          <div className="mt-6">
            ...
            <div className="bg-transparent p-4 text-white rounded">
              ...
              {generatedContent.map((gift)=>{
                 return <li className="font-medium">{gift}</li>
              })}
        ...
        <div className="footer">
          <p className="text-center font-semibold text-xl mt-2 shadow-md">Made with  ❤️  by <a className="text-blue-400" href="https://www.linkedin.com/in/arion-das/">Arion</a>  and <a className="text-blue-400" href="https://www.linkedin.com/in/aialok/">Alok</a> : ) <br />🎄 Merry Christmas🎄</p>
